...
\begin{itemize}
    ...
    \item \textbf{5-6 (Diamonds):} Targets are \textbf{blinded} until the start of your next turn by a flash of prismatic light.
\end{itemize}
...
You summon a spectral revolver with a single bullet in the chamber and aim it at a creature within range. Choose a number between 1 and 6, then roll a \textbf{d6}.

\begin{itemize}
    \item \textbf{Match (The Shot):} If you roll the chosen number, the spell scores a catastrophic hit. The target takes \textbf{10d10 necrotic damage}.
    \item \textbf{No Match (The Click):} If you roll any other number, the tension snaps. The target takes \textbf{3d10 psychic damage}.
    \item \textbf{Natural 1 (The Backfire):} If you chose 1 and rolled a 1, or if you roll a 1 regardless of your choice, you take \textbf{3d10 necrotic damage} as the gun explodes in your hand (the target takes no damage).
\end{itemize}
